...
| Firefox Quick Dictionary | Firefox dictionary with highlight, context-menu, toolbar search, and adaptive themes; users provide their own API keys | [Source](extensions/firefox-quick-dictionary/) | [ZIP](downloads/firefox-quick-dictionary-v1.3.0.zip) |

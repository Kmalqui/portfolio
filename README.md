...
|---|---|---|---|
| MeetingScribe | Local meeting notes with Eco live transcription, optional voice cleanup, and soft pastel light/dark themes | [Source](tools/meetingscribe/) | [Windows installer](https://github.com/Kmalqui/portfolio/releases/download/meetingscribe-v0.3.6-beta/MeetingScribe-0.3.6-beta-One-Click-Windows-Setup.exe) |
